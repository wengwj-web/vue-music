      ...
      <div class="list-wrapper" @click.stop>
        <div class="list-header">
          <h1 class="title">
            ...
            <span class="clear" @click="showComfirm"><i class="icon-clear"></i></span>
          </h1>
        </div>
        <scroll :data="sequenceList" :refreshDelay="refreshDelay" ref="listContent"  class="list-content" >
          <transition-group name="list" tag="ul">
            <li :key="item.id" ref="list" class="item" v-for="(item, index) in sequenceList" @click="selectItem(item,index)">
